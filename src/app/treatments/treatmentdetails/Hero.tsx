      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              <div className="inline-block px-3 py-1 bg-primary/10 text-primary rounded-full text-sm mb-4 font-medium">
                <motion.div variants={itemVariants}>
                  {dictionary.treatments.ayurvedicTreatment || "Ayurvedic Treatment"}
                </motion.div>
              </div>
              
              <div className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-primary">
                <motion.h1 variants={itemVariants}>
                  {treatment.title}
                </motion.h1>
              </div>
              
              <div className="text-lg md:text-xl text-text/80 mb-8 max-w-2xl mx-auto lg:mx-0">
