...
export default function MissionVision({ dictionary, locale }: MissionVisionProps) {
  ...
  const iconVariants = {
    initial: { scale: 1 },
    hover: { scale: 1.1, transition: { repeat: Infinity, repeatType: "reverse", duration: 1 } }
  };
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <MotionWrapper 
            ...
            className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 p-8"
          >
          ...
          >
            <div className="flex flex-col items-center text-center">
              <MotionWrapper
                ...
                whileHover="hover"
                variants={iconVariants}
                className="w-16 h-16 rounded-full bg-accent/10 flex items-center justify-center mb-6 text-accent"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
