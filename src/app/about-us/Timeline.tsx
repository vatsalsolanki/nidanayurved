      ...
      <div className="container mx-auto px-4">
        ...
        <div className="hidden md:block relative">
          ...
          >
            ...
            <MotionWrapper
              className="absolute top-[170px] left-[130px] w-[400px] h-[180px]"
            ...
            <MotionWrapper
              className="absolute top-[170px] right-[130px] w-[400px] h-[180px]"
              variants={cardVariants}
            >
              <div className="bg-[#EFF3EA] rounded-xl shadow-md h-full p-6 flex flex-col justify-between">
                <div>
            ...
            <MotionWrapper
              className="absolute top-[430px] left-[130px] w-[400px] h-[180px]"
              variants={cardVariants}
            >
              <div className="bg-[#EFF3EA] rounded-xl shadow-md h-full p-6 flex flex-col justify-between">
                <div>
            ...
            <MotionWrapper
              className="absolute top-[430px] right-[130px] w-[400px] h-[180px]"
              variants={cardVariants}
            >
              <div className="bg-[#EFF3EA] rounded-xl shadow-md h-full p-6 flex flex-col justify-between">
                <div>
